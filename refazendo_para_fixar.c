...
int consulta() { // Função consulta
    ...
    fclose(arquivo);
    system("pause"); // Pausa para o usuário entender o que aconteceu 
}
...
int cadastro() { // Função cadastro
    ...
    char cpf[12], nome[100], sobrenome[15], cargo[30]; // Declarando Variáveis tipo string caracter
...
int deletar() { // Função deletar
    ...
    system("pause"); // Pausa para o usuário ler as mensagens 
}
